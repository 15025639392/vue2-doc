...
export function isObject(data){
    return objString.call(data) === '[object Object]'
}

export function isFn(data){
    return objString.call(data) === '[object Function]'
}

export function getCurrentIcon(obj){
...
export function calcAction(dataSource, actions, permissions,permissionsReqiured) {
  ...
  function getFixedAction(action, item) {
    ...
    const children = dropdownMenu.filter(r => {
